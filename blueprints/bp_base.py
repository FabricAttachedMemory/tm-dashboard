...
class Journal():
    """
        A Journal in this context is a class that contains Flask Blueprints and Routes.
    Couldn't come up with better alternative the the word "blueprint" and using the
    same word as Flask's class Blueprint is "context confusing".
    """
